import styles from "../styles/SolutionCards.module.css"
...
export function SolutionCards() {
    return (
        <section className="px-0 py-[100px]">
            <div className={styles.solutionCardsWrapper + " flex justify-between"}>
                <div className={styles.colLeft}>
                    <h2 className="text-blue general-title">Discover the most powerful retail planning solution</h2>
                    <p className="general-text">Drive smarter decisions with flexible, highly configurable tools that offer instant access to personalized views and real-time analyses. Leverage advanced AI and analytics to enhance retail planning accuracy and forecast for maximized margins. Scale effortlessly, ensuring faster reporting and seamless performance across operations.</p>
                </div>
                <div className={styles.colRight + " w-1/2"}>
                    <div className={styles.solutionCardsContent}>
